...
class OpenAiErrorService extends Component
{
    ...
    public function handleException(\Exception $e): \Exception
    {
        if ($e instanceof RateLimitException) {
            ...
            Craft::error('OpenAI API rate limit error: ' . $sanitizedMessage, 'alt-pilot');
        ...
        Craft::error('OpenAI API error: ' . $sanitizedMessage, 'alt-pilot');
    ...
    public function validateResponse(mixed $response): void
    {
        ...
        if (!$hasChoices) {
            ...
            Craft::error($errorMessage . ' - Response type: ' . gettype($response) . ' - Response: ' . $responseDebug, 'alt-pilot');
    ...
    private function throwStructureError(string $type, string $class = ''): void
    {
        ...
        Craft::error($errorMessage . $details, 'alt-pilot');
