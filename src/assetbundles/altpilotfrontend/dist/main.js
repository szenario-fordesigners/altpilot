...
`], ...formatTraceEntry(entry));
  ...
  function useActiveElement(options = {}) {
    ...
    if (window$1) {
      ...
      useEventListener(window$1, "focus", trigger2, listenerOptions);
    }
    if (triggerOnRemoval) onElementRemoval(activeElement, trigger2, { document: document$1 });
    trigger2();
  ...
  const _sfc_main$b = /* @__PURE__ */ defineComponent({
    ...
    setup(__props, { expose: __expose, emit: __emit }) {
      ...
      const __returned__ = { props, emit: emit2, sites, cpTrigger, primarySiteId: primarySiteId2, suppressOverwriteWarning, confirmationOpen, pendingGenerationSiteId, currentSiteId, currentAsset, currentSiteHandle, charactersRemaining, altTexts, hasChanges, hasSiteChanges, saving, save, resetChanges, generateForSite, generatingBySite, isGenerationActive, isGenerationFinished, isGeneratingSite, getTextareaValue, handleTextareaInput, handleGenerateClick, handleConfirmOverwrite, handleCancelOverwrite, handleSave, handleCancel, cardRef, focused, meta_s, ctrl_s, get assetStatusShort() {
  ...
  const AssetCard = /* @__PURE__ */ _export_sfc(_sfc_main$b, [["render", _sfc_render$b], ["__scopeId", "data-v-956fabe0"], ["__file", "AssetCard.vue"]]);
