...
<template>
  <div class="relative">
    <input
      v-model="searchQuery"
      type="text"
      class="block h-12 w-full rounded-2xl border border-ap-dark-green pr-12 pl-12 text-xl text-ap-dark-green transition-colors focus:bg-ap-light-green/30 focus:ring-0 focus:ring-ap-dark-green focus:outline-none"
    />
