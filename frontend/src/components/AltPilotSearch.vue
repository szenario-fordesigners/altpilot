...
<template>
  <div class="relative">
    <input v-model="searchQuery" type="text" class="text-xl block h-12 w-full rounded-2xl border border-ap-dark-green pl-12 pr-12 text-ap-dark-green
        focus:outline-none focus:ring-0 focus:ring-ap-dark-green focus:bg-ap-light-green/30 transition-colors" />
